...
class RateAdapter(val list: ArrayList<RateModel>) :
    RecyclerView.Adapter<RateAdapter.RateAdapterViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RateAdapterViewHolder {
        val layoutInflater: LayoutInflater = LayoutInflater.from(parent.context)
        val binding: OpinionBinding =
            DataBindingUtil.inflate(layoutInflater, R.layout.opinion, parent, false)
    ...
    inner class RateAdapterViewHolder(var itemview: OpinionBinding) :
